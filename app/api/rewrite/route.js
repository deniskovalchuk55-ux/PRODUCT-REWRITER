...
Створи УНІКАЛЬНИЙ структурований опис РОСІЙСЬКОЮ мовою. НЕ копіюй текст дослівно — переформулюй своїми словами, але ЗБЕРЕЖИ всі факти, цифри та характеристики з джерела. НІЧОГО не відкидай — переноси всю змістовну інформацію.
...
Поверни СТРОГО JSON без markdown:
{
  ...
  "seo_title": "SEO-заголовок до 60 символів (рос)",
  "seo_description": "SEO-опис до 160 символів (рос)"
}
...
ВАЖЛИВО про "title" (SEO-назва, РОСІЙСЬКОЮ): будуй за гнучким принципом під цей товар:
[тип/категорія] + [уточнення типу] + [бренд і модель] + [ключові характеристики] + [розмір/обʼєм/вага] + [призначення/сценарії] + [колір].
Мета — щоб товар знаходився за багатьма пошуковими запитами. Пиши грамотно; де доречно — вживай популярне слово яким реально шукають (напр. "Павербанк"), але без нагромадження синонімів і без зміни звичних назв. Довжину обирай під товар.`;
