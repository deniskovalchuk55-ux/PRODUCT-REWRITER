...
4а. НЕ втрачай і НЕ спрощуй технічні деталі: типи й кількість розʼємів, підтримувані стандарти (QC, PD тощо), сумісність, комплектацію, час роботи. Якщо в джерелі є такі деталі — обовʼязково включи їх у відповідний блок опису. Краще детальніше, ніж втратити важливе.
...
МОВА І СЛОВА: пиши грамотною українською (без русизмів і кальок). Де це доречно — вживай популярне слово, яким товар РЕАЛЬНО шукають (напр. "Павербанк" замість довгого "портативний зарядний пристрій"). Але НЕ нагромаджуй синоніми і НЕ міняй назву там, де вона й так звична та зрозуміла (термос, басейн, стіл — лишай як є). Одне влучне слово, а не перелік варіантів.`;
